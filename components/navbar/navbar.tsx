...
const JNavbar = () => {
  ...
  return (
    <>
      <header className="max-w-[768px] w-full px-4 mx-auto pt-3">
        <JLogo withTitle />
      </header>
      <button
      ...
      <div
        className={`top-0 right-0 w-[100vw] bg-white pl-8 pt-8  pr-4 text-netural-90 fixed h-full flex flex-col justify-between items-end ease-in-out duration-300 ${
